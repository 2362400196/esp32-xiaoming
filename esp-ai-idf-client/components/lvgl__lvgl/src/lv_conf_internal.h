 ...
 *E.g. #define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(my_font_1) LV_FONT_DECLARE(my_font_2)*/
    ...
    #else
        /* 固件内置全量中文字体（16px），声明后可供 LV_FONT_DEFAULT 全局使用 */
        #define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(font_puhui_16_4)
    #endif
#endif

/*Always set a default font*/
/* 全局默认字体改为固件内置中文字体 font_puhui_16_4：
 * Lua 脚本与 LVGL 原生控件默认即可显示中文。
 * 注意：必须无条件覆盖，否则 Kconfig 的 CONFIG_LV_FONT_DEFAULT 会拦截。 */
#define LV_FONT_DEFAULT &font_puhui_16_4
