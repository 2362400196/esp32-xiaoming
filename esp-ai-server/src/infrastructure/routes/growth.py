...
def register_routes(app: FastAPI) -> None:
    ...
    @app.get("/api/v1/growth/diary/{device_id}", tags=["growth"])
    ...
    @app.get("/api/v1/growth/diary/{device_id}/{date}", tags=["growth"])
    ...
    @app.get("/api/v1/growth/profile/{device_id}", tags=["growth"])
    ...
    @app.get("/api/v1/growth/emotions/{device_id}", tags=["growth"])
