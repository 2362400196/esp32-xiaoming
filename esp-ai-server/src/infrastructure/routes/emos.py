...
from fastapi import Depends, FastAPI, Form, Request, UploadFile, File, HTTPException, Response
...
def register_routes(app: FastAPI) -> None:
    ...
    @app.get("/api/v1/emos/{device_id}", tags=["emos"])
    ...
    @app.post("/api/v1/emos/packs/create", tags=["emos"])
    ...
    @app.delete("/api/v1/emos/packs/{pack_name}", tags=["emos"])
    ...
    @app.post("/api/v1/emos/packs/{pack_name}/upload", tags=["emos"])
    ...
    # ── 兼容旧上传接口 ──
    @app.post("/api/v1/emos/upload", tags=["emos"])
    ...
    @app.post("/api/v1/emos/maker/sources", tags=["emos"])
    ...
    @app.post("/api/v1/emos/maker/process", tags=["emos"])
    ...
    @app.get("/api/v1/emos/active/{device_id}", tags=["emos"])
    ...
    @app.post("/api/v1/emos/active/{device_id}", tags=["emos"])
