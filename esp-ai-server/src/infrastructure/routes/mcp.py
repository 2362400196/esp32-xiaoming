...
def register_routes(app: FastAPI) -> None:
    ...
    @app.get("/api/v1/devices/{mac}/mcp", tags=["mcp"])
    ...
    @app.put("/api/v1/devices/{mac}/mcp/{server_name}", tags=["mcp"])
    ...
    @app.delete("/api/v1/devices/{mac}/mcp/{server_name}", tags=["mcp"])
    ...
    @app.get("/api/v1/devices/{mac}/mcp/{server_name}/tools", tags=["mcp"])
    ...
    @app.get("/api/v1/devices/{mac}/tools", tags=["mcp"])
    ...
    @app.post("/api/v1/devices/{mac}/mcp/{server_name}/toggle", tags=["mcp"])
    ...
    @app.post("/api/v1/devices/{mac}/mcp/{server_name}/tools/{tool_name}/toggle", tags=["mcp"])
    ...
    @app.get("/api/v1/devices/{mac}/mcp/disabled", tags=["mcp"])
